...
import { Calendar, MapPin, Clock, Users, Minus, Plus, Star, Share2, Heart, ArrowLeft, Check } from "lucide-react";
...
const EventDetail = () => {
  ...
  const handleAddToCart = () => {
    addToCart({
      ...
      price: event.tickets[selectedTicket].price,
      quantity,
    });
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="container mx-auto px-4 pb-8">
            ...
            >
              ...
              <p className="text-xl text-black/80 drop-shadow-md">{event.artist}</p>
            </motion.div>
          </div>
        </div>
      </section>
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground text-sm">(234 avaliações)</span>
                  </div>
                  <div className="flex gap-2">
                    <button
                      onClick={() => setIsFavorite(!isFavorite)}
                      className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${
                        isFavorite ? "bg-accent text-accent-foreground" : "bg-muted text-muted-foreground"
                      }`}
                    >
                ...
                <h3 className="font-display text-xl font-bold mb-4">Selecione seu ingresso</h3>
